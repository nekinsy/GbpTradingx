    ...
    <div class="dashboard-inner">
        <div class="alert border--info border" role="alert">
            ...
            <p class="alert__message">
                <span class="fw-bold">
                    @lang('Withdrawals made within 72 hours (Balance Day not included)')
                </span>
            </p>
        </div>
                ...
                <div class="card custom--card">
                    <div class="card-body">
                        <form action="{{ route('user.withdraw.money') }}" method="post">
                            ...
                            @if(date('l') === 'Saturday')  
                                <button class="btn btn--base w-100 submitBtn mt-3 disabled" type="submit" >@lang('Brokerage Day')</button>  
                            @else  
                                @if(auth()->user()->weekly_paid == Status::USER_WEEKLY_NOT_PAID)  
                                    <button class="btn btn--base w-100 submitBtn mt-3 disabled" type="submit">@lang('Weekly Deposit is not enough')</button>  
                                @else  
