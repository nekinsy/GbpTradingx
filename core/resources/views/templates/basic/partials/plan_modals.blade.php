<div class="modal fade" id="profitInfoModal" role="dialog" aria-hidden="true" tabindex="-1">
...
<div class="modal fade" id="aa" role="dialog" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="durationInfoModal" role="dialog" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="inviteCountModal" role="dialog" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="bonusAmoutModal" role="dialog" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="{{ route('user.plan.purchase') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="form-control border-0" style = "margin-bottom: 15px">
                        ...
                        <div class="modal-footer">
                            <button class="btn btn--base w-100 form-control" type="submit">@lang('Submit')</button>
                        </div>
                </form>
            </div>
        </div>
