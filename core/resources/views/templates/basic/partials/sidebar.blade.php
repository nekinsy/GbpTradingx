<div class="dashboard-sidebar" id="dashboard-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <!--</li>-->
        <li>
            <a href="{{ route('user.package.index') }}" class="{{ menuActive('user.package.index') }}">
                <img src="{{ asset($activeTemplateTrue . 'users/images/icon/invest1.png') }}" alt="icon"> @lang('Investment Plan')
            </a>
        </li>
