...
class Status{
    ...
    const PACKAGE_GET_DAILY_INCOME = 5;
    const PACKAGE_CONTRIBUTE_NETWORK_BONUS = 6;

    const PACKAGE_TYPE_FIXED = 1;
    const PACKAGE_TYPE_VARIABLE = 2;
    ...
    const USER_ACTIVE = 1;
    const USER_BAN = 0;
    const USER_WEEKLY_NOT_PAID = 1;
    const USER_WEEKLY_PAID = 3;
