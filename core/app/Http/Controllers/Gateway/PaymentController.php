...
class PaymentController extends Controller
{
    public function deposit(Request $request)
    {
        ...
        $deposit_amount = $brokerage_fee == null ? 0 : $brokerage_fee;
        return view($this->activeTemplate . 'user.payment.deposit', compact('gatewayCurrency', 'pageTitle', 'deposit_amount'));
    }
